...
function Starter() {
  ...
  useEffect(() => {
    const originalText = 'Board Infinity';
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center">
      <Image
        ...
        width={300}
        height={10}
        className="w-22 md:w-20 pb-10 mb-10 mx-auto md:pb-0 object-contain  border-white border-2"
      />
      <div className=" flex justify-center">
        <p className="animated-text my-auto font-extrabold text-zinc-950 text-5xl">
          {text}
        </p>
      </div>
    </div>
